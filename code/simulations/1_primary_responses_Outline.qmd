...
d_mus = log(0.5)/t_halfs #half lives in days
...
plot = ggplot() + 
  ...
  geom_hline(yintercept = log10(A0), lientype = "dashed") +
  theme_bw() +
  labs(x = "time, days", y = "specific antibody inside, Ms", col = "Mucosal Ab half life, days")+
...
{with(as.list(parms),	# allows the parameter file parms to be as a list
      {  
        ...
        #####################################
        r = function(t) {r_0 - alpha*t} #define time-varying r(t)
        #####################################
        ## calculate the derivatives
        # cell populations
        dMs = r(t = t)*Ms - d_mu*M_s # specific Ab production and decay
...
alpha = ((r_0-d_mu)^2)/log(Ap/A0) # rate of decay of exponential growth rate
