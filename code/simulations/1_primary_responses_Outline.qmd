...
M_s = function(A0, t_p, r, d_mu, t) {(A0/(1+exp(-r*(t-t_p))))*(1/(exp(d_mu*(t_p-t))))} #sigmoidal growth, A0 is max antibody, t_p is half the time to peak, r is initial growth
...
# plot 
plot = ggplot() + 
  geom_line(data = Ms, aes(x = time, y = Ms, group = thalf, col = thalf)) +
  geom_hline(yintercept = A0, lientype = "dashed") +
  theme_bw() +
